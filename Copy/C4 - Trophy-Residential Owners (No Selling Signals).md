# C4 - Trophy / Residential Owners (No Selling Signals)  *(Phase 2)*
...
### E1-D — Client Suggested Variant (pending ad-review) · subject: `before you sell your home`
```
Hi {{firstName}},

Thinking about selling a home you've owned for years?

Most people assume the capital gains tax is just the cost of doing it. It
doesn't have to be.
...
One seller I helped kept $1.1M of it on a $7.6M sale.
...
*Client-suggested. Flags for ad-review: "kept $1.1M" reads as permanent (it is deferred, paid over time), and that client was investment real estate, not a primary home; sign-off is "Mitchell." Kept verbatim per client.*
